...
class ApplicationBasic:
    ...
    def setup_window(self):
        ...
        self.canvas = Canvas(self.window, bg='bisque', height=height - 40, width=width)
    ...
    def setup_window_components(self):
        ...
        self.open_btn.config(image=self.open_img, command=self.draw_from_file)
    ...
    def draw_from_file(self, file_path):
        with open(file_path, 'r') as file:
            for line in file:
                ...
                line_form = self.canvas.create_line(coords[0], coords[1], coords[2], coords[3], width=3)
